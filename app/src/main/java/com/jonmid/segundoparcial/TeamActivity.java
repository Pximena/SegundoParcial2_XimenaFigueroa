...
import com.jonmid.segundoparcial.Adapter.TeamAdapterFigueroaXimena;
import com.jonmid.segundoparcial.Connection.Connection;
import com.jonmid.segundoparcial.Models.TeamModelFigueroaXimena;
import com.jonmid.segundoparcial.Parser.TeamJsonFigueroaXimena;
...
public class TeamActivity extends AppCompatActivity {
    ...
    List<TeamModelFigueroaXimena> albumModelList;
    TeamAdapterFigueroaXimena teamAdapterFigueroaXimena;
    ...
    public void processData(){
        teamAdapterFigueroaXimena = new TeamAdapterFigueroaXimena(albumModelList, getApplicationContext());
        recyclerViewAlbum.setAdapter(teamAdapterFigueroaXimena);
    }
    ...
    public class TaskAlbum extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                albumModelList = TeamJsonFigueroaXimena.getData(s);
